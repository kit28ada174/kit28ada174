...
vaishnavy = {
    ...
    "degree":      "B.Tech – Artificial Intelligence & Data Science (II Year)",
    "cgpa":        "9.27 / 10.0",
    "code":        ["Python", "C", "C++", "Java", "JavaScript"],
    "ml_stack":    ["Machine Learning", "Deep Learning", "Self-Supervised Learning"],
...
A database-driven payroll application automating employee salary processing, attendance tracking, tax computation, and payslip generation — improving HR accuracy and reducing manual errors.

`MongoDB` `Express.js` `React` `Node.js`

---

### 🔊 Self-Supervised Audio Learning *(Python | Deep Learning)*
Implemented a deep-learning-based self-supervised framework to learn audio representations from **unlabeled data**, enabling effective feature extraction for downstream speech and sound-classification tasks.

`Python` `Deep Learning` `Self-Supervised Learning` `Audio AI`
...
- 🏅 **Tamil Nadu State-Level Women's Hackathon 2024** — Collaborated to build innovative tech-based solutions
- ⚡ **CodeXtreme – 24-Hour Hackathon** at KIT, Coimbatore — Rapid problem-solving under pressure
- 🌐 **24-Hour Full-Stack Hackathon** at KPR Institute of Engineering and Technology (IEEE CS SYP)

---

## 📜 Certifications

![Infosys](https://img.shields.io/badge/Infosys-Business_Communication-0070C0?style=flat-square)
![Cisco](https://img.shields.io/badge/Cisco-OS_Basics-1BA0D7?style=flat-square)
![Cisco](https://img.shields.io/badge/Cisco-Python_Essentials_1%262-1BA0D7?style=flat-square)
![Guvi](https://img.shields.io/badge/Guvi-Data_Engineering_%26_Big_Data-orange?style=flat-square)
![NPTEL](https://img.shields.io/badge/NPTEL-DSA-blue?style=flat-square)
![NPTEL](https://img.shields.io/badge/NPTEL-C++-blue?style=flat-square)
![Coursera](https://img.shields.io/badge/Coursera-Web_Basics-0056D2?style=flat-square)
![Coursera](https://img.shields.io/badge/Coursera-AI_Essentials-0056D2?style=flat-square)
...
**Currently working on:** AI/ML Projects + MERN Stack Development

**Learning:** Deep Learning, Data Engineering, Cloud Basics

**Next Goal:** Contribute to Open Source & Build an AI Portfolio

---

## 🤝 Let's Connect!

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/vaishnavy-r-07641b359)
